  ...
  return (
    <div className="page homepage">
      <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
        <Col span={12} className="selected-course" style={{ borderRight: '1px solid #F0F0F0' }}>
          ...
          </div>} dataSource={selCourse} />
        </Col>
        <Col span={12} className="available-schedule">
          {/* <div className="view-available-course btn">
            <Button onClick={viewAvailableCourses}>View Available Schedule</Button>
          </div> */}
          <List header={<div><CheckCircleOutlined style={{marginRight: "0.5rem"}}/><span>Available Schedule</span></div>} />
        </Col>
      </Row>
    </div>
  );
